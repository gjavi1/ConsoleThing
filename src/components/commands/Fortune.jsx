...
export default class Fortune {
    ...
    static do(command) {
        let fortunes = [
            ...
            "Fortune: You will be attacked next Wednesday at 3:15 p.m. by six samuraisword wielding purple fish glued to Harley-Davidson motorcycles.Oh, and have a nice day!\n-- Bryce Nesbitt '84",
        ...
        return {message: fortunes[Math.floor(Math.random()*(fortunes.length + 1))]};
    }

    static help() {
        return <span>Predetermines your fortune.</span>
    }
